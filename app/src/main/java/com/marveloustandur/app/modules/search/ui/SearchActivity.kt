package com.marveloustandur.app.modules.search.ui
...
import com.marveloustandur.app.databinding.ActivitySearchBinding
import com.marveloustandur.app.modules.jobdetailstabcontainer.ui.JobDetailsTabContainerActivity
import com.marveloustandur.app.modules.search.`data`.model.SearchRowModel
import com.marveloustandur.app.modules.search.`data`.viewmodel.SearchVM
...
class SearchActivity : BaseActivity<ActivitySearchBinding>(R.layout.activity_search) {
  ...
  override fun setUpClicks(): Unit {
    binding.viewView.setOnClickListener {
